...
- 首次安装**默认关闭平衡版**，可在 Lethe 菜单中开启。配置保存在 `BepInEx/config/encounters.muga.ryoshu.cfg` 的 `[Encounter] BalancedMode`
...
- 触发上述效果后的下回合开始时，改变行动模式，理智上限变为0点，将不足50层的[无我]补至50层，并清空自身的负面状态
